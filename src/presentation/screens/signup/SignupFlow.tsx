...
export const SignupFlow: React.FC<SignupFlowProps> = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {currentStep === 'step1' && (
        <SignupStep1 onNext={handleStep1Complete} onBack={handleBackFromStep1} />
      )}

      {currentStep === 'step2' && (
        <SignupStep2 onNext={handleStep2Complete} onBack={handleBackFromStep2} />
      )}

      {currentStep === 'step3' && (
        <SignupStep3 onNext={handleStep3Complete} onBack={handleBackFromStep3} />
      )}
